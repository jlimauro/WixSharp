    ...
    public class ManagedActionsTest
    {
        ...
        public void Should_Normalize_AsmReferences()
        {
            var project = new Project("test",
                ...
                new ManagedAction("action_11", "test.dll"),
                new ManagedAction("action_22", "test.dll") { RefAssemblies = new[] { "asm5.dll", "asm7.dll" } },
                new ManagedAction("action_33", "test.dll") { RefAssemblies = new[] { "asm6.dll", "asm8.dll" } });
